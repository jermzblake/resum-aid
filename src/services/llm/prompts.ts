export const analyzeBulletPrompt = (bullet: string) => {
  return `Analyze the following resume bullet point for clarity, impact, and overall quality. Provide a score from 1 to 10, a brief summary of its strengths and weaknesses, and suggestions for improvement.
